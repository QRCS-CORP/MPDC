...
#ifndef MPDC_RESOURCES_H
#define MPDC_RESOURCES_H

/**
* \file resources.h
* \brief The MPDC common resources
*/

#define MPDC_APPLICATION_MESSAGE_STRING_DEPTH 167U
#define MPDC_APPLICATION_MESSAGE_STRING_SIZE 128U
#define MPDC_APPLICATION_COMMAND_STRING_DEPTH 10U
#define MPDC_APPLICATION_COMMAND_STRING_SIZE 64U
#define MPDC_APPLICATION_CONSOLE_MODE_STRING_DEPTH 14U
#define MPDC_APPLICATION_CONSOLE_MODE_STRING_SIZE 23U
#define MPDC_APPLICATION_HELP_STRING_DEPTH 48U
#define MPDC_APPLICATION_HELP_STRING_SIZE 128U

static const char MPDC_APPLICATION_MESSAGE_STRINGS[MPDC_APPLICATION_MESSAGE_STRING_DEPTH][MPDC_APPLICATION_MESSAGE_STRING_SIZE] =
{
...
static const char MPDC_APPLICATION_HELP_STRINGS[MPDC_APPLICATION_HELP_STRING_DEPTH][MPDC_APPLICATION_HELP_STRING_SIZE] =
{
	"unknown command",
	...
	"register [ip-address] -register agent with the DLA",
	"resign [ip-address] -resign from the DLA",
...
static const char MPDC_APPLICATION_MODE_STRINGS[MPDC_APPLICATION_CONSOLE_MODE_STRING_DEPTH][MPDC_APPLICATION_CONSOLE_MODE_STRING_SIZE] =
{
	"MPDC",
	"> ",
	"# ",
